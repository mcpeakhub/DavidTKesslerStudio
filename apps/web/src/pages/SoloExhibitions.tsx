...
const exhibitions = [
	{ year: "2025", venues: ["Bentley Gallery, Phoenix, AZ"] },
	{ year: "2019", venues: ["Bentley Projects, Phoenix, AZ"] },
	{ year: "2017", venues: ["Desert Botanical Garden, Phoenix, AZ"] },
	{ year: "2016", 
		venues: [
	...
	{ year: "2015", venues: ["Marietta Cobb Museum of Art, Marietta, GA"] },
	{ year: "2013, 2014", venues: ["Stricoff Fine Art, New York, NY"] },
	{ year: "2012",
		venues: [
			"Stricoff Fine Art, New York, NY",
	...
	{ year: "1979", venues: ["Phil Descind's Capricorn Gallery, Bethesda, MD"] },
